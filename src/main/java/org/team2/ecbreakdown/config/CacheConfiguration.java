...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("economicBreakdown");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("economicBreakdown");
        ...
        config.getMapConfigs().put("org.team2.ecbreakdown.domain.*", initializeDomainMapConfig(jHipsterProperties));
